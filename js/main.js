...
/*************************************************************************************
------------ ANSWER -------------------
 - The variables aren't what they claim, x is actually global and y is local.
 - If console.log(y) were uncommented it would not print anything because y is out of 
 scope.  
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will print undefined because x is declared but not assigned anything due
to hoisting.  console.log(y) won't print anything because it's not there
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
 Inside the IFEE it will print 4.  Outside will give undefined since it's out of scope.
**************************************************************************************/
...
(function(){
  "use strict";
  var date = new Date(419734812000);
  var birthday;
  bdayMsg();
...
(function(testerTwo){
  "use strict";
  var stringDate = new Date("June 12, 2017");
  var today = new Date();
